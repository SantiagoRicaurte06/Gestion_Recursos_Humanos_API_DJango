...
class Empleados(models.Model):
    ...
    id_tipos_documento = models.ForeignKey(TipoDocumento, on_delete=models.SET_NULL, null=True, blank=True, db_column='id_tipos_documento')
    ...
    id_generos = models.ForeignKey(Genero, on_delete=models.SET_NULL, null=True, blank=True, db_column='id_generos')
    id_estados_civiles = models.ForeignKey(EstadoCivil, on_delete=models.SET_NULL, null=True, blank=True, db_column='id_estados_civiles')
